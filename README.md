...
## 方法一：一键安装或更新到最新 ##
 <pre><code>wget -q -N --no-check-certificate https://raw.githubusercontent.com/iluoye/nps-socks5/master/install_nps.sh && chmod 777 install_nps.sh && bash install_nps.sh</code></pre>
